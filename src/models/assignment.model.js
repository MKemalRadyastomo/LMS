...
Assignment.create = async (assignmentData) => {
    try {
        const { course_id, title, description, type, due_date, max_score, quiz_questions_json, allowed_file_types, max_file_size_mb } = assignmentData;
        const query = `
            INSERT INTO assignments (
                course_id, title, description, type, due_date, max_score,
